...
Source: L1_Port_and_Contract_Design.md (Phase 4, Sections 2.3, 3.advice.md, 3.2, 3.3).
"""
...
from cognitiveplane.shared.types import CaseId, EventId
...
# ---------------------------------------------------------------------------
# Section 3.advice.md -- Domain event base
# ---------------------------------------------------------------------------
...
from cognitiveplane.shared.enums import BrainInternalEventType  # noqa: E402
from cognitiveplane.shared.types import DecisionId  # noqa: E402
from cognitiveplane.shared.enums import FallbackMode  # noqa: E402
from cognitiveplane.shared.enums import RiskLevel  # noqa: E402
from cognitiveplane.shared.types import MemoryId  # noqa: E402
from cognitiveplane.shared.types import ValidationId  # noqa: E402
