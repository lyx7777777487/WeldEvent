...
Source: L1_Port_and_Contract_Design.md (Phase 4, Section 6.1).
"""
...
from src.brain.ports import BrainDecisionRepository


class InMemoryBrainDecisionRepository(BrainDecisionRepository):
    """In-memory implementation backed by plain dicts.

    Keyed by decision_id.value for O(1) lookups.  A secondary index maps
