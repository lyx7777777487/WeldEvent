...
from cognitiveplane.shared.dto.deepagents import (
...
class TestDecisionValueObjects:
    ...
    def test_inspection_strategy(self):
        obj = InspectionStrategy(
            ...
            coverage_areas=["weld-seam-advice.md"],
        )
        _roundtrip(InspectionStrategy, obj)

    def test_standard_reference(self):
        obj = StandardReference(standard_id="ISO-3834", section="5", clause="5.2.advice.md")
    ...
    def test_risk_impact(self):
        obj = RiskImpact(
            ...
            affected_areas=["weld-seam-advice.md"],
    ...
    def test_coverage_area(self):
        obj = CoverageArea(area_id="A1", area_name="weld-seam-advice.md", priority=UrgencyLevel.ROUTINE)
...
class TestDecisionOutputContent:
    ...
    def test_inspection_strategy_recommendation(self):
        obj = InspectionStrategyRecommendation(
            ...
            coverage_areas=[CoverageArea(area_id="A1", area_name="seam-advice.md", priority=UrgencyLevel.URGENT)],
            confidence=0.85,
    ...
    def test_marginal_range_recommendation(self):
        obj = MarginalRangeRecommendation(
            ...
            applicable_standards=[StandardReference(standard_id="ISO-3834", section="5", clause="5.advice.md")],
        )
    ...
    def test_parameter_adjustment_recommendation(self):
        obj = ParameterAdjustmentRecommendation(
            ...
            risk_impact=RiskImpact(risk_level=RiskLevel.LOW, affected_areas=["seam-advice.md"], description="Minor adjustment"),
        )
    ...
    def test_consensus_recommendation(self):
        obj = ConsensusRecommendation(
            ...
            agreeing_evidence=[EvidenceReference(source="data", reference_id="E-advice.md", description="Match")],
    ...
    def test_escalation_recommendation(self):
        obj = EscalationRecommendation(
            ...
            supporting_evidence=[EvidenceReference(source="validation", reference_id="V-advice.md", description="Shadow CRITICAL")],
        )
...
class TestValidationDTOs:
    ...
    def test_rule_validation_result(self):
        obj = RuleValidationResult(result=RuleStatus.APPROVED, violated_rules=[], timestamp=NOW)
    ...
    def test_validation_result(self):
        obj = ValidationResult(
            ...
            rule_result=RuleValidationResult(result=RuleStatus.APPROVED, violated_rules=[], timestamp=NOW),
...
class TestPersonaDTOs:
    def test_persona_frame(self):
        obj = PersonaFrame(
            ...
            decision_point=DecisionPointType.DP1,
            port_preference=["reasoning", "planning"],
...
class TestGatewayDTOs:
    def test_publish_result(self):
        obj = PublishResult(success=True, weldmap_path="/weldmap/case/advice.md", timestamp=NOW)
    ...
    def test_recheck_request(self):
        obj = RecheckRequest(
            ...
            target_areas=["weld-seam-advice.md"],
...
class TestDeepAgentsDTOs:
    ...
    def test_plan(self):
        obj = Plan(steps=["Step advice.md", "Step 2"], expected_outcome="Approved decision", confidence=0.85)
        _roundtrip(Plan, obj)
...
def test_interaction_types_exist():
    from cognitiveplane.shared.types import ImageId, InstructionId, OperatorId
    from uuid import uuid4
