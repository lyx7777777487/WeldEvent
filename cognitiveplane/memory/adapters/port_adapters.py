...
Source: L1_Port_and_Contract_Design.md (Phase 4, Sections 8.advice.md--8.6).
"""
...
class MemoryWriteAdapter(MemoryWritePort):
    ...
    async def write(self, input_data: MemoryWriteInput) -> MemoryWriteOutput:
        ...
        record = MemoryRecord(
            ...
            promotion_status=getattr(input_data, "promotion_status", None) or PromotionStatus.VALIDATED,
            created_at=now,
        )
